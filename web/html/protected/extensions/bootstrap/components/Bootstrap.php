...
class Bootstrap extends CApplicationComponent
{
	...
	{
		$filename = 'bootstrap.min.css';// YII_DEBUG ? 'bootstrap.css' : 'bootstrap.min.css';
	...
	public function registerResponsiveCss()
	{
		...
		$filename = 'bootstrap-responsive.min.css';//YII_DEBUG ? 'bootstrap-responsive.css' : 'bootstrap-responsive.min.css';
	...
	protected function registerJS($position = CClientScript::POS_HEAD)
	{
        ...
        $filename = 'jquery-2.0.0.min.js';
        $cs->registerScriptFile($this->getAssetsUrl().'/js/'.$filename, $position);

        $filename = 'bootstrap.min.js';// YII_DEBUG ? 'bootstrap.js' : 'bootstrap.min.js';
		$cs->registerScriptFile($this->getAssetsUrl().'/js/'.$filename, $position);
	}
